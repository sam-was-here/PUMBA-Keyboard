...
#define PS2_KEY_NUM         0X01	// was 0x01, change to unreal num so dont break
#define PS2_KEY_SCROLL      0X02	// was 0x02
#define PS2_KEY_CAPS        0X03	// was 0x03
...
#define PS2_KEY_LANG1       0X96  // now num lock
#define PS2_KEY_LANG2       0X97  // scroll lock
#define PS2_KEY_LANG3       0X98  // cap lock
